...
if (!text) return conn.reply(m.chat, `Url o link`, m)
...
try {
if (text === '🎶' || text === 'audio') {
await conn.reply(m.chat, "descargando", fkontak, m || null)
