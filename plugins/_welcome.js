...
async function generarBienvenida({ conn, userId, groupMetadata, chat }) {
  ...
  const imageUrl = `https://goo.su/Vtek/api/generate/welcome2?username=${encodeURIComponent(username)}&guildName=${encodeURIComponent(groupMetadata.subject)}&memberCount=${groupSize}&avatar=${encodeURIComponent(pp)}&background=https://files.catbox.moe/7cckvp.jpg&key=hYSK8YrJpKRc9jSE`
...
async function generarDespedida({ conn, userId, groupMetadata, chat }) {
  ...
  try {
    ...
    try {
      const fallbackUrl = `https://goo.su/Vtek/api/generate/goodbye2?username=${encodeURIComponent(username)}&guildName=${encodeURIComponent(groupMetadata.subject)}&memberCount=${groupSize}&avatar=${encodeURIComponent(pp)}&background=https://i.ibb.co/4YBNyvP/images-76.jpg&key=hYSK8YrJpKRc9jSE`
