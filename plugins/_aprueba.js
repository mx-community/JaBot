...
if (!text) {
return conn.sendMessage(m.chat, { text: `Ingrese el comando y escriba un texto para crear un logo.\n\n• Por ejemplo:\n*${usedPrefix + command}* Alan.Js` }, { quoted: m });
}
await m.react("⏳");
const modelos = {
...
await conn.sendMessage(m.chat, { image: { url: data }, caption: `🖼️  *generate-logo-${text}.jpg*` }, { quoted: m });
};
