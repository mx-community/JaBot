...
> кαиєкι вσт ν3 | 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚂𝙷𝙰𝙳𝙾𝚆-𝚇𝚈𝚉`.trim()
    ...
    // Solo un documento, con etiqueta personalizada debajo
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        // Aquí añadimos la etiqueta personalizada tipo "Menu List"
        productMessage: {
          product: {
            productImage: { jpegThumbnail: Shadow_url },
            title: "🍰 Menu List",
            description: "Finaliza el jun. 27.\nCódigo: I LOVE XRLJOSE",
            currencyCode: "USD",
            priceAmount1000: 0,
            retailerId: "kanekibot"
          }
        }
      }
    }, { quoted: fkontak })
